...
const ConfirmTransfer = () => {
  const [isAuthGmail, setIsAuthGmail] = useState(false)
  ...
  return (
    <Card bordered={false}>
      <Row gutter={[32, 32]}>
        ...
        <Col span={24}>
          <AuthGmailApi onConnected={setIsAuthGmail} />
        </Col>
        <Col span={24}>
          <Row gutter={[8, 8]}>
            <Col span={12}>
